    ...
    <Container>
      ...
      <Container alignContent="center" alignItems="center">
        ...
        <Container maxWidth={['100%', '720px']} marginY="2rem">
          <Text>I&apos;m a Software Dev who studied in Munich, Germany.</Text>
          <Text>
            I am currently building my early stage startup by unleashing the
            advantages of blockchain for the masses.
          </Text>
        </Container>
      </Container>
            ...
            >
              ...
              <Grid width="100%" gridTemplateColumns="4fr 1fr">
                ...
                >
                  ...
                  <Text fontSize="1rem">{data.post}</Text>
...
export const getStaticProps: GetStaticProps = async () => {
  const experiences = await getPosts();
